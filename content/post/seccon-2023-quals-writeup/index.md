...
デバッガで処理を追っていくと、まず入力の長さが29文字であることを確認し、次に`入力 xor 文字のインデックス xor 0x55 xor 謎のデータ`の結果が`謎のデータその2`と一致すると正解になることが分かります。入力のかわりに`謎のデータその2`とxorすればFlagが逆算できますね。
...
{{< x user="kymn_" id="1703278268059979787" >}}
...
{{<x user="pwnyaa" id="1703283949328576549">}}
...
{{<x user="shojin_comp" id="1703306637300417000">}}
{{<x user="moratorium08" id="1703332110596227311">}}
...
戒め:
{{<x user="n_g_k_z" id="1703276281159458847">}}

完全に忘れてました:
{{<x user="n_g_k_z" id="1703276979536240869">}}
